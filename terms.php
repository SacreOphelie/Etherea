...
<body>
    ...
    <div class="content-mention">
        <div id="mention"">
            ...
            <p>Access to the site and its use are reserved for strictly personal use. You agree not to use this site and the information or data contained therein for commercial, political, or advertising purposes or for any form of commercial solicitation, including the sending of unsolicited emails.</p>
            <h2>Content of the Site</h2>
            <p>TAll trademarks, photographs, texts, comments, illustrations, animated or non-animated images, video sequences, sounds, as well as all computer applications that could be used to operate this site and more generally all elements reproduced or used on the site are protected by the laws in force concerning intellectual property. They are the full and entire property of the publisher or its partners. Any reproduction, representation, use, or adaptation, in any form whatsoever, of all or part of these elements, including computer applications, without the prior written consent of the publisher, is strictly prohibited. The fact that the publisher does not initiate legal proceedings upon becoming aware of such unauthorized use does not constitute acceptance of said use and a waiver of prosecution.</p>
            <h2>Site management</h2>
            <p>For the proper management of the site, the publisher may at any time:
                <ul>
                    <li>suspend, interrupt, or limit access to all or part of the site,</li>
                    <li>restrict access to the site, or certain parts of the site, to a specific category of users,</li>
                    <li>Delete any information that may disrupt its operation or violate national or international laws,</li>
                    <li>suspend the site for updates.</li>
                </ul></p>
